...
//             <div
//               key={product._id}
//               className="bg-white text-center rounded-lg shadow-md"
//             >
...
//           </h2>          <p className="text-sm md:text-lg mb-6">            Sign up for our newsletter and receive exclusive offers on new            ranges, sales, pop-up stores, and more.          </p>          <div className="flex justify-center gap-4 md:gap-6 text-sm md:text-base mb-8 flex-wrap">            {["Exclusive offers", "Free events", "Large discounts"].map(
//              (benefit, index) => (                <div key={index} className="flex items-center gap-2"                   <span className="text-lg">✔</span> {benefit}                </div>              )
//           )}          </div>
...
//             </div>
//             <div className="text-center bg-pink-100 p-6 rounded-lg shadow-md">
//               <FaCircleCheck className="text-4xl mx-auto mb-4" />
...
//             </div>
//             <div className="text-center bg-pink-100 p-6 rounded-lg shadow-md">
//               <CiCreditCard1 className="text-4xl mx-auto mb-4" />
...
//             </div>
//             <div className="text-center bg-pink-100 p-6 rounded-lg shadow-md">
//               <RiLeafFill className="text-4xl mx-auto mb-4" />
...
//       {/* Section: Image on One Side, Text on the Other */}
//       <div className="flex flex-col lg:flex-row items-center bg-gray-50 py-10 px-6 lg:px-20">
//         {/* Image */}
...
//             Our products are crafted with the utmost care and attention to
//             detail. Embrace sustainable, elegant, and functional designs for
//             your home.
//           </p>
//           <Link href="/about">
