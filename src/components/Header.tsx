...
function Header() {
  ...
  return (
    <div className="relative flex items-center border-b-2 p-2">
      ...
      <div className="relative">
        ...
        />
        {searchOpen && (
          <div className="absolute top-full left-0 w-64 bg-white border p-2 rounded-md shadow-lg z-40">
            <input
              type="text"
            ...
            {filteredProducts.length > 0 && (
              <ul className="mt-2">
                {filteredProducts.map((product) => (
                  <li key={product.slug.current} className="p-2 border-b">
